# Protein_Expression
Visualizes a heatmap of local quantity ratios of presegmented superbright protein expression blobs with respect to all blobs in mouse physical slice images acquired by transmission microscopy.
